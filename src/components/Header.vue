...
<template>
	<header class="border-b border-slate-200">
		<div class="container">
			<div class="header__inner flex justify-between items-center py-11">
				<router-link to="/">
				...
				<ul class="flex items-center justify-between gap-8">
					<li
						...
						class="flex items-center gap-3 cursor-pointer font-medium text-gray-500 hover:text-black ease-in duration-200"
					>
						<svg
							width="20"
							height="20"
						...
						<span class="font-bold text-black">{{ totalPrice }} руб.</span>
					</li>
